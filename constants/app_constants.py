...
ARTIST_TEXT_KEY = 'Artist'  # Can be replaced with the value of the artist key in your text file
TRACK_TITLE_TEXT_KEY = 'Track Title'  # Can be replaced with the value of the track title key in your text file
LOCATION_TEXT_KEY = 'Location'  # Can be replaced with the value of the location key in your text file
