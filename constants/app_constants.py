...
SQLITE_DB_PATH = r"F:\Bureau\vlc_media.db"  # Update this to the path of your SQLite database file
ORIGINAL_TRACKS_FILE_PATH = 'F:\Téléchargements\\Juillet\\'  # Update this to the directory where your tracks are initially located before being moved by the playlist
PROCESSING_TRACKS_FILE_PATH = 'D:\Rename\\'  # Update this to the directory where your tracks are stored for processing
